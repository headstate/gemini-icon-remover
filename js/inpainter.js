...
class Inpainter {
    ...
    inpaint(imageData, mask, progressCallback = null) {
        ...
        while (fillFront.length > 0 && iteration < this.maxIterations) {
            ...
            if (bestMatch) {
                ...
                confidence[targetIdx] = 1.0;
                
                // Mark as filled
                workingMask[targetIdx] = 0;
                filledPixels++;
            }
    ...
    static _analyzeCorner(data, width, height, startX, startY, regionW, regionH) {
        ...
        // - Lower color variance than natural images
        // - Often semi-transparent (check alpha if available)
        ...
        // Good edge density for text/logos
